/-
MATH70040 - Formalising Mathematics 2023-2024
Title: Project 2
...
/-!
# Project 3: A closed unit ball is compact if and only if
# the corresponding vector space is finite dimensional

In this file we define and prove a theorem from third year functional analysis
course.
The theorem states that for a normed vector space, the closed unit ball
...
lemma fin_dim_Y_span_riesz {X : Type} [NormedAddCommGroup X] [NormedSpace ℝ X]
  ...
  have hY : Y = Submodule.span ℝ F := by simp only [Subtype.exists, Set.Finite.coe_toFinset]
  rw [hY]
...
-- were written and partially proved by Dr. Bhavik Mehta.
